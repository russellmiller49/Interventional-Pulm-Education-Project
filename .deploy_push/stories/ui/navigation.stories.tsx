  ...
  render: () => (
    <Accordion type="single" collapsible className="w-full max-w-2xl space-y-3">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          <p className="text-sm text-muted-foreground">
            You&apos;ll need the printable airway phantom, a standard bronchoscopy tower, and the
            open-source analytics app. Suggested 3D printer settings are linked within the module
            guide.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          <p className="text-sm text-muted-foreground">
            Metrics focus on practical skill acquisition, adherence to safety checklists, and
            reflective assessments authored by clinical leads.
          </p>
        </AccordionContent>
      </AccordionItem>
    </Accordion>
