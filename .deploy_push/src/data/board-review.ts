...
export const boardReviewChapterMap = boardReviewChapters.reduce<
  Record<string, BoardReviewChapterMeta>
>((acc, chapter) => {
  acc[chapter.slug] = chapter
  return acc
}, {})

export const boardReviewChapterBySourceFile = boardReviewChapters.reduce<
  Record<string, BoardReviewChapterMeta>
>((acc, chapter) => {
