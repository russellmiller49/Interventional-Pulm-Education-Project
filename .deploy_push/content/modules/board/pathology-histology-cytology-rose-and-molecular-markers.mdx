...
G --> I[Driver panel by NGS DNA with RNA]
I --> J{Specific fusion suspected ALK/ROS1/RET/NTRK?}
J -->|Yes, limited tissue| K[Orthogonal IHC with FISH prioritized]
J -->|No| L[NGS-first strategy]
H & K & L --> M[Integrated report → Tumor board]
M --> N{Progression later?}
N -->|Yes| O[Plasma ctDNA with tissue re-biopsy]
...
B -->|Yes| C[Order PD-L1 + broad NGS DNA with RNA]
...
H --> I{Progression?}
I -->|Yes| J[Re-biopsy with liquid biopsy; evaluate resistance e.g., T790M, METamp, histologic transformation]
```
