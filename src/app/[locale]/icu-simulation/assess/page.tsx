...
export default async function IcuSimulationAssessPage({ params, searchParams }: PageProps) {
  ...
  return (
    <IcuCapstoneEntry mode="assess" locale={locale} requestedScenarioId={requestedScenarioId} />
  )
}
