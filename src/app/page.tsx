    ...
    <div className="space-y-24 py-12 md:py-16">
        ...
        <div className="grid gap-12 overflow-hidden rounded-3xl border border-border/70 bg-muted/30 p-8 md:grid-cols-[1.1fr_0.9fr] md:p-12">
          <div className="space-y-6">
            ...
            <p className="text-base text-muted-foreground md:text-lg">
              From printable anatomy and hands-on labs to analytics-ready registries, we are co-creating the
              infrastructure that accelerates training and research in interventional pulmonology—no gatekeepers, no
              license fees.
            </p>
          ...
          <div className="relative isolate">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-slate-100 shadow-xl">
              <div className="space-y-4">
                <p className="text-sm uppercase tracking-[0.4em] text-slate-300/80">Inside the lab</p>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-xs text-slate-200/80">
                  <p className="font-semibold uppercase tracking-[0.3em] text-slate-200">Training modules live</p>
                  <p className="mt-1 text-sm font-medium text-white">{trainingModules.length}+ competency tracks</p>
                  <p className="text-xs text-slate-300">Download checklists, watch annotated cases, and export QA reports.</p>
                </div>
              </div>
              <div className="mt-8 rounded-2xl border border-white/10 bg-slate-900/60 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300">Rigid scope rehearsal · Real-time analytics</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section aria-labelledby="quick-access" className="container space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-2xl text-muted-foreground">
            Get where you need to go—whether you&apos;re launching a tool, preparing a fellow, or printing tomorrow&apos;s model.
          </p>
        </div>
      ...
      <section aria-labelledby="cta" className="container">
        <div className="grid gap-8 overflow-hidden rounded-3xl border border-border/70 bg-primary/10 p-10 md:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <Badge variant="info" className="rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary-foreground">
              Stay in the loop
            </Badge>
            <h2 id="cta" className="text-3xl font-semibold tracking-tight text-primary-foreground md:text-4xl">
              Contribute, collaborate, and get the latest drops
            </h2>
            <p className="text-base text-primary-foreground/80 md:text-lg">
              Star the GitHub org to follow releases, and join the mailing list for calls for contributors, new modules,
              and anatomy drops.
            </p>
            <div className="flex flex-wrap gap-3">
              <Button asChild elevated>
                <Link href="https://github.com/interventional-pulm" target="_blank" rel="noreferrer">
                  Visit GitHub
                </Link>
              </Button>
              <Button variant="outline" className="border-white/60 bg-white/10 text-primary-foreground hover:bg-white/20">
                Coming soon
              </Button>
            </div>
          </div>
          ...
          >
            ...
            <input
              ...
              disabled
            />
            <Button type="submit" disabled className="h-11 rounded-full bg-white text-primary hover:bg-white">
              Notify me (soon)
            </Button>
            <p className="text-xs text-primary-foreground/70">
              We&apos;re finalizing the community newsletter. No spam—just release notes and collaboration invites.
            </p>
          </form>
        </div>
      </section>
