    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-semibold tracking-tight">Yearlong Rigid Bronchoscopy Curriculum</h2>
          <p className="text-sm text-muted-foreground">
            Twelve-month progression blending didactics, simulation, live case application, and reflection. Expand any month
            to review objectives, clinical focus areas, practice labs, and assessment prompts.
          </p>
        </div>
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary" className="rounded-full px-3 py-1 text-[11px] uppercase tracking-[0.3em]">
                      Month {month.month}
                    </Badge>
                    <span className="text-xs text-muted-foreground">Rigid Bronchoscopy Foundations</span>
                  </div>
