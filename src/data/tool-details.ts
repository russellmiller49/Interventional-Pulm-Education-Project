...
export const toolDetails: Record<string, ToolDetail> = {
  'test-track': {
    ...
    documentationLinks: [
      { label: 'Architecture overview', href: 'https://github.com/interventional-pulm/test_track/wiki/Architecture' },
      { label: 'Assessment rubric guide', href: 'https://github.com/interventional-pulm/test_track/wiki/Rubrics' },
    ],
    supportLinks: [
      { label: 'Slack community', href: 'https://interventionalpulm.org/slack' },
      { label: 'GitHub discussions', href: 'https://github.com/orgs/interventional-pulm/discussions' },
    ],
  },
  'test-reg': {
    slug: 'test-reg',
    ...
    gettingStarted: {
      requirements: ['Node.js 18+', 'Supabase project or Postgres instance', 'SendGrid API key for notifications'],
      steps: [
  ...
  medparse: {
    ...
    features: [
      {
        ...
        description: 'Processes scanned PDFs, DICOM headers, and HL7 feeds into consistent text blocks for analysis.',
      },
      {
        title: 'Custom Entities',
        description: 'Extracts device names, anatomical landmarks, and staging systems specific to interventional pulmonology.',
      },
      {
        title: 'Plan Composer',
        description: 'Generates editable procedure plans with recommended codes, supplies, and follow-up tasks.',
      },
      {
        title: 'Feedback Loop',
    ...
    gettingStarted: {
      requirements: ['Python 3.11', 'CUDA-capable GPU optional', 'Access to de-identified clinical documents'],
      steps: [
    ...
    supportLinks: [
      { label: 'Model tuning guide', href: 'https://github.com/interventional-pulm/Medparse/wiki/Tuning' },
    ],
  },
  'ip-assist-lite': {
    slug: 'ip-assist-lite',
    ...
    features: [
      {
        title: 'Offline Mode',
        description: 'Preloads calculators and protocol content so procedure rooms with poor Wi-Fi stay covered.',
      },
      {
        title: 'Team Checklist',
        description: 'Real-time checklist that multiple team members can update with instant sync when connectivity returns.',
      },
      {
      ...
      },
      {
        ...
        description: 'Host equipment sizing charts, troubleshooting guides, and video pearls for quick consults.',
      },
    ],
    useCases: [
    ...
    gettingStarted: {
      requirements: ['Node.js 18+', 'Expo CLI', 'Apple/Google developer accounts for native builds'],
      steps: [
    ...
    features: [
      {
        ...
        description: 'Combine scope feed, fluoroscopy, ultrasound, and vitals into one synchronized timeline.',
      },
      {
        title: 'Annotation Studio',
        description: 'Mark teaching moments, complications, and decisions with chapter markers and drawing tools.',
      },
      {
        title: 'Playlist Builder',
        description: 'Assemble case libraries with objectives, pre-reading, and reflection prompts.',
      },
      {
        title: 'Compliance Safeguards',
        description: 'Automatically blur PHI, enforce retention policies, and log view history for governance.',
      },
    ],
    useCases: [
  ...
  'pocus-review': {
    ...
    features: [
      {
        title: 'Case Packs',
        description: 'Download structured packs that bundle loops, checklists, and interpretation keys.',
      },
      {
        title: 'Adaptive Review',
        description: 'Learners rate confidence and receive tailored follow-up cases using spaced repetition.',
      },
      {
      ...
      {
        title: 'Offline First',
        description: 'Progressive web app caches loops and transcripts for use in low-connectivity settings.',
      },
    ],
    useCases: [
