...
export const featuredMakeProject: MakeProject = {
  ...
  downloads: [
    {
      ...
      description: 'Segmented airway, vascular tree, and modular base plates ready for 200 x 200 mm printers.',
      format: 'stl',
      sizeMB: 185,
  ...
  buildGuide: {
    ...
    materials: [
      { name: 'PLA filament (1.75 mm)', quantity: '2 spools', cost: '$40', notes: 'Use higher temp PLA+ for durability.' },
      { name: 'Silicone tubing (6 mm ID)', quantity: '3 meters', cost: '$9' },
      { name: 'Peristaltic pump (12 V)', quantity: '1', cost: '$28', notes: 'For bleeding/secretions simulation.' },
      { name: 'Arduino Nano + relay shield', quantity: '1 set', cost: '$18' },
      { name: 'Neoprene sheet (3 mm)', quantity: '300 x 300 mm', cost: '$6', notes: 'Base padding.' },
      { name: 'M4 hardware kit', quantity: '1 pack', cost: '$12' },
    ],
    printing: {
      description: 'Print the airway cartridges upright with supports and the base plates flat for rigidity. A 0.2 mm layer height and 20% gyroid infill balance strength and material use.',
      steps: [
    ...
    assembly: [
      {
        ...
        description: 'Wet-sand support scars and seal the airway lumen with a thin silicone coat to improve scope glide.',
        image: undefined,
      },
      {
        title: 'Install tubing manifold',
        description: 'Route silicone tubing through the anterior port, anchoring with M4 screws and compression gaskets.',
        image: undefined,
      },
      {
        title: 'Wire control box',
        description: 'Solder the pump, LEDs, and sensors to the relay shield as per the wiring guide, then upload firmware.',
        image: undefined,
      },
      {
        title: 'Final enclosure fit',
        description: 'Mount the airway cartridge, secure the removable cover, and perform a leak test with water.',
      },
    ],
    usageTips: [
