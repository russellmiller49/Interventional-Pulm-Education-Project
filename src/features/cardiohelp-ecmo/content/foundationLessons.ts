...
export const ecmoFoundationSections: readonly EcmoFoundationSection[] = Object.freeze([
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'The return limb faces whatever resistance lies downstream of it — the cannula, the vessel, and in VA support the patient’s own arterial circulation. This is the source of the module’s central claim: circuit blood flow is not effective flow, because what the circuit moves and what reaches the tissues are separated by where the blood is returned and what happens to it there.',
    ],
    bullets: [
  ...
  // ---- VV track ----
  {
    ...
    paragraphs: [
      ...
      'This is the VV form of that central claim. A displayed flow that has not changed, or has even risen, is compatible with a falling effective flow — most commonly because cannula position, patient volume state, or cardiac output has shifted the relationship between the drainage and return points.',
