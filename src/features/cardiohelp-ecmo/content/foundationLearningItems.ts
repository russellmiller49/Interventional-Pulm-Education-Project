...
const authored: Readonly<Record<EcmoInteractiveFoundationSectionId, EcmoFoundationLearningItems>> =
  {
    ...
    'pump-and-pressure-zones': {
      prediction: {
        ...
        contextRequirement: 'context-independent',
        stem: 'From the stable reference circuit, the pump speed is about to be raised by 400 rpm. What should happen to circuit blood flow and to the drainage pressure?',
        choices: [
          {
