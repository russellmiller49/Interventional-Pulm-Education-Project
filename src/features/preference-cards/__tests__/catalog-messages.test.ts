...
const parameterizedMessages: Record<string, string[]> = {
  ...
  'modules.requirementCount': ['count'],
  'admin.page': ['page', 'pages'],
  'admin.eligibleProductCount': ['count'],
  'admin.inheritedFrom': ['module'],
  'admin.excelExportProductAccessible': ['product'],
  'admin.excelExportProductProposals': ['count'],
  'admin.excelScopeFiltered': ['count'],
  'admin.excelScopeAll': ['count'],
  'admin.excelScopeRequired': ['count'],
  'admin.excelExportReady': ['count'],
  'admin.excelImportPreviewReady': ['count'],
  'admin.excelPreviewDescription': ['filename'],
  'admin.excelRowIssuesTitle': ['count'],
  'admin.excelRowIssueSummary': ['row', 'key'],
  'admin.excelNormalizedPreviewTitle': ['count'],
  'admin.excelExportUnreviewed': ['count'],
  'admin.excelNormalizedExportReady': ['format'],
  'admin.clinicalUseReviewExportReady': ['products', 'roles', 'slots'],
  'admin.clinicalUseReviewImportReady': ['count'],
