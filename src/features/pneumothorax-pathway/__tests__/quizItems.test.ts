import { pneumothoraxQuizQuestions } from '../content/quizItems'

describe('pneumothorax assessment items', () => {
  it('has a meaningful number of questions', () => {
    expect(pneumothoraxQuizQuestions.length).toBeGreaterThanOrEqual(6)
  })

  it('every question has a valid answer index and distinct options', () => {
    for (const question of pneumothoraxQuizQuestions) {
