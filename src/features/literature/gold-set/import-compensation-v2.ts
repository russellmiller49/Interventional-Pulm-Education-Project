...
/**
 * Exact PostgreSQL-normalized identities from the reviewed V2 migration on the pinned runtime.
 * The ready-audit boundary checks every semantic function against this map so a database with a
 * checksum-rebound validator, projection, hash, receipt, trigger, or transition body cannot
 * authorize its own replacement contract.
 */
