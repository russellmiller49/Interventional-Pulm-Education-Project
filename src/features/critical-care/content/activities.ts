...
const hemodynamicsLearnSeeds: readonly ActivitySeed[] = [
  ...
  //
  // The flow rebuild (2026-09-05) put one orientation section ahead of the runway: why a pressure
  // line is placed at all, what it adds to the bedside picture, and what it cannot say on its own.
  // It is the ladder's first rung and the hub's "Start here"; nothing gates on it.
  {
    sourceId: 'why-measure',
    ...
    evidenceIds: [...hemodynamicsEvidence, 'pac-review-2014'],
    estimatedMinutes: 6,
  },
  {
    ...
    competencyIds: ['signal-validation', 'critical-care-safety'],
    pathwayIds: ['shock-and-perfusion'],
    prerequisiteActivityIds: ['hemodynamics:learn:why-measure'],
    evidenceIds: [
  ...
  {
    // The flow rebuild split the waveform section in two: naming the place from its shape is one
    // idea, and reading a diagnosis from the waves inside a known place is another.
    sourceId: 'waveform-components',
    difficulty: 'intermediate',
    curriculumStage: 'mechanism',
    stageOrder: 2,
  ...
  },
  {
    ...
    competencyIds: ['signal-validation', 'critical-care-safety'],
    pathwayIds: ['shock-and-perfusion'],
    prerequisiteActivityIds: ['hemodynamics:learn:waveform-components'],
