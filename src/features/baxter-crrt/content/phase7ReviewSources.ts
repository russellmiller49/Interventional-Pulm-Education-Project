...
const candidateToolCalibrationSources = [
  ...
  // This stable authored-structure record is not clinical authority. Batch C registers
  // physiology separately in citrateSources.ts; both kinds remain pending review.
  {
    id: 'SYNTH-LAB-CITRATE-001',
    claim:
      'The citrate first-use terms and the four-way citrate comparison are authored teaching structures. This record describes the drawn entry, return, calcium-support and sampling locations in this module’s schematic. Physiology and sampling interpretation require their separate clinical-publication records.',
    value:
