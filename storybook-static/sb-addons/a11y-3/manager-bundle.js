    ...
    var rl = __STORYBOOK_API__,
      {
        ...
        internal_universalTestProviderStore: _l,
        isMacLike: Rl,
        isShortcutTaken: Tl,
        keyToSymbol: Cl,
        merge: Ol,
    ...
    var Xm = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        PREVIEW_KEYDOWN: vd,
        REGISTER_SUBSCRIPTION: Ad,
        REQUEST_WHATS_NEW_DATA: xd,
        RESET_STORY_ARGS: $d,
        RESULT_WHATS_NEW_DATA: _d,
      ...
      on = (e) => {
        ...
        let [R, C] = V(() => {
          ...
          ne = E(
            (m, b) => {
              let [p, _] = m.split('.'),
                { helpUrl: k, nodes: be } = d?.[p]?.find((oe) => oe.id === _) || {},
        ...
        ;(O(() => {
          ...
          O(() => {
            ...
            let m = Array.from(R.values()).flatMap((p) => {
              let [_, k, be] = p.split('.')
              if (_ !== s.tab) return []
              let he = d?.[_]?.find((oe) => oe.id === k)?.nodes[Number(be) - 1]?.target
              return he ? [String(he)] : []
            })
            m.length &&
              Y(_e, {
                ...
                menu: d?.[s.tab].map((p) => {
                  ...
                  return [
                    { id: `${s.tab}.${p.id}:info`, title: Ye(p), description: je(p), selectors: _ },
                    {
                      id: `${s.tab}.${p.id}`,
                      iconLeft: 'info',
                      iconRight: 'shareAlt',
            ...
            let b = d?.[s.tab]
              .flatMap((p) => p.nodes.flatMap((_) => _.target).map(String))
    ...
    function dn(e) {
      let t = e + 'CollectionProvider',
        ...
        o = (g) => {
          ...
          return n.createElement(l, { scope: h, itemMap: R, collectionRef: $ }, T)
        }
      ...
      let s = e + 'CollectionItemSlot',
        ...
        f = n.forwardRef((g, h) => {
          let { scope: T, children: $, ...R } = g,
            ...
            Q = i(s, T)
          return (
            n.useEffect(() => (Q.itemMap.set(C, { ref: C, ...R }), () => void Q.itemMap.delete(C))),
      ...
      function S(g) {
        ...
        return n.useCallback(() => {
          ...
          return Array.from(h.itemMap.values()).sort(
            (R, C) => $.indexOf(R.ref.current) - $.indexOf(C.ref.current),
          )
    ...
    var Be = 'rovingFocusGroup.onEntryFocus',
      ...
      Xt = w((e, t) =>
        y(
          ...
          y(Qe.Slot, { scope: e.__scopeRovingFocusGroup }, y(_n, P({}, e, { ref: t }))),
        ),
      )
    ...
    var _n = w((e, t) => {
        ...
        return (
          ...
          y(
            ...
            y(
              ce.div,
              P({ tabIndex: $ || ke === 0 ? -1 : 0, 'data-orientation': r }, d, {
                ref: S,
                ...
                onFocus: X(e.onFocus, (D) => {
                  let re = !Q.current
                  if (D.target === D.currentTarget && re && !$) {
