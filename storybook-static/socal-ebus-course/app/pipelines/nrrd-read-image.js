var nrrdReadImage = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      if (Module['locateFile']) {
        var f = 'nrrd-read-image.wasm'
        if (!isDataURI(f)) {
          return locateFile(f)
        }
        return f
      }
      return new URL('nrrd-read-image.wasm', import.meta.url).href
    }
    var wasmBinaryFile
    ...
    var wasmImports = {
      ...
      h: ___syscall_openat,
      r: ___syscall_readlinkat,
      w: ___syscall_stat64,
      p: ___syscall_unlinkat,
      o: ___syscall_utimensat,
      q: __abort_js,
      A: __emscripten_memcpy_js,
    ...
    var _itk_wasm_input_array_alloc = (Module['_itk_wasm_input_array_alloc'] = (a0, a1, a2, a3) =>
      (_itk_wasm_input_array_alloc = Module['_itk_wasm_input_array_alloc'] = wasmExports['E'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var _itk_wasm_input_json_alloc = (Module['_itk_wasm_input_json_alloc'] = (a0, a1, a2) =>
      (_itk_wasm_input_json_alloc = Module['_itk_wasm_input_json_alloc'] = wasmExports['F'])(
        a0,
        a1,
        a2,
      ))
    var _itk_wasm_output_json_address = (Module['_itk_wasm_output_json_address'] = (a0, a1) =>
      (_itk_wasm_output_json_address = Module['_itk_wasm_output_json_address'] = wasmExports['G'])(
        a0,
        a1,
      ))
    var _itk_wasm_output_json_size = (Module['_itk_wasm_output_json_size'] = (a0, a1) =>
      (_itk_wasm_output_json_size = Module['_itk_wasm_output_json_size'] = wasmExports['H'])(
        a0,
        a1,
      ))
    var _itk_wasm_output_array_address = (Module['_itk_wasm_output_array_address'] = (a0, a1, a2) =>
      (_itk_wasm_output_array_address = Module['_itk_wasm_output_array_address'] =
        wasmExports['I'])(a0, a1, a2))
    var _itk_wasm_output_array_size = (Module['_itk_wasm_output_array_size'] = (a0, a1, a2) =>
      (_itk_wasm_output_array_size = Module['_itk_wasm_output_array_size'] = wasmExports['J'])(
        a0,
        a1,
        a2,
      ))
    var _itk_wasm_free_all = (Module['_itk_wasm_free_all'] = () =>
      (_itk_wasm_free_all = Module['_itk_wasm_free_all'] = wasmExports['K'])())
    var __emscripten_timeout = (a0, a1) => (__emscripten_timeout = wasmExports['M'])(a0, a1)
    ...
    function applySignatureConversions(wasmExports) {
      ...
      wasmExports['O'] = makeWrapper_pp(wasmExports['O'])
      wasmExports['P'] = makeWrapper_p(wasmExports['P'])
      return wasmExports
    }
