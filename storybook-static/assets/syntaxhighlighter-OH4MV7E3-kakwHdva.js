...
import { r as we, b as G, e as Z, h as F } from './iframe-AbuOJf2D.js'
            ...
            return (
              (S = S.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (E, _) {
                if (((_ = _.toLowerCase()), _[0] === '#')) {
                  var A
                  return (
                    _[1] === 'x' ? (A = parseInt(_.slice(2), 16)) : (A = Number(_.slice(1))),
                    x(A)
                  )
                } else {
                  var i = C[_]
        ...
        a = (function (n) {
          ...
          f.stringify = function i(s, p) {
            ...
            var m = {
              ...
              c = s.alias
            ;(c &&
              (Array.isArray(c) ? Array.prototype.push.apply(m.classes, c) : m.classes.push(c)),
              l.hooks.run('wrap', m))
            var w = ''
    ...
    '../../node_modules/refractor/core.js'(e, r) {
      ...
      function E(c, w) {
        ...
        if (b.util.type(w) === 'Object') ((k = w), (w = null))
          ...
          if (typeof w != 'string') throw new Error('Expected `string` for `name`, got `' + w + '`')
...
var Vn = (0, rn.default)(2)((e) =>
  ...
  ea = ({ children: e, className: r }) =>
    G.createElement(bt, { horizontal: !0, vertical: !0, focusable: !0, className: r }, e),
  ta = Ee(ea)(
