...
export const GOLD_ENRICHMENT_V3_COORDINATOR_SCHEMA_VERSION = '3.0.1' as const
export const GOLD_ENRICHMENT_V3_MERGED_SCHEMA_VERSION = '3.0.2' as const
export const GOLD_ENRICHMENT_V3_VALIDATION_REPORT_SCHEMA_VERSION = '3.0.2' as const
export const GOLD_ENRICHMENT_V3_READINESS_SCHEMA_VERSION = '3.0.2' as const
export const GOLD_ENRICHMENT_V3_LEGACY_PREPARED_MERGED_SCHEMA_VERSION = '3.0.1' as const
