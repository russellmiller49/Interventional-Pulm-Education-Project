...
const directory = resolve(root, 'EBUS-course/apps/web/public/simulator/case-001/models/guided-v1')
const scratch = localDataPath('raw-assets', 'ebus-guided-models', 'phase-1', 'optimized')
