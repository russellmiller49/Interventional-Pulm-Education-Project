...
Mapped to: AABIP/CAQ IP domains on oncologic diagnostics and programmatic screening.

Key Topics: Eligibility, shared decision-making, CTLS technical standards, Lung-RADS v2022, nodule management and escalation (PET/CT, biopsy, bronchoscopy, surgery), benefits/harms (mortality, false positives, complications, radiation), special populations (COPD/ILD, cancer survivors), and evolving tools (risk models, biomarkers).
...
Coverage nuance (CMS): Typically ages 50–77 with the same pack-year and quit-time requirements and documented shared decision-making; always confirm local payer rules.
...
CTLS protocol: Noncontrast, ≤2.5 mm slices, volumetric CT dose index (CTDIvol) around 3 mGy for standard-sized patients; effective dose ~1–1.5 mSv per exam.

Lung-RADS v2022: Size/growth thresholds drive management.

Growth: &gt;1.5 mm (mean) over 12 months.
4A: New solid 6–&lt;8 mm or growing &lt;8 mm → 3-mo LDCT (consider PET if solid ≥8 mm).
4B: Persistent proximal/segmental airway nodule at 3 months → Diagnostic evaluation (often bronchoscopy).
...
Common exam traps: Ordering chest radiographs for screening, using “diagnostic-dose” CT instead of LDCT, skipping shared decision-making, ordering PET for sub-8 mm solid nodules, and misclassifying airway/cystic lesions.

Core Concepts

Pathophysiology / Epidemiology

Lung cancer remains the leading cause of cancer death. Survival is tightly linked to stage at diagnosis; screening shifts detection toward curable stages. LDCT in high-risk populations reduces disease-specific mortality, with consistent signal across large trials.
...
CMS/Medicare (coverage): Commonly 50–77 years with the same pack-year/quit criteria; documented shared decision-making (SDM) visit required.
...
Cover eligibility: Review potential benefits (stage shift, mortality reduction) and harms (false positives, downstream procedures, incidentalomas, radiation, overdiagnosis, anxiety).

Commitment: Emphasize annual commitment; a single negative LDCT does not “clear” future risk.

Documentation: Document the use of at least one decision aid and offer cessation resources.
...
COPD and fibrotic ILD: Elevate risk significantly. If otherwise eligible and fit, screening is appropriate; anticipate higher rates of indeterminate findings and tailor follow-up.
Cancer survivors: Thoracic oncology patients (e.g., prior lung cancer ≥5 years) often face elevated second-primary risk; follow NCCN disease-specific surveillance or consider individualized screening.
...
Dose: Dose modulation by patient size; typical CTDIvol around 3 mGy; effective dose ~1–1.5 mSv/exam.
QA: Track dose in a registry and benchmark locally/nationally.
...
Registry/QI: Track adherence, callback timeliness, positive predictive value, benign resection rate, and radiation metrics.

Troubleshooting & Intra-procedure Management

Lung-RADS 0 (Incomplete)

Motion, limited coverage, or suspected acute infection/inflammation. Remedy by retrieving priors or repeating LDCT in 1–3 months (then re-categorize).

Infection/inflammation

Segmental/lobar consolidation, multiple new nodules (&gt;6), or large solid nodules appearing over short intervals—consider Category 0 with 1–3 month LDCT; reassign at follow-up.

Airway nodules

Subsegmental/multifocal tubular opacities favor secretions → typically benign/Category 0–2.
...
Atypical cystic lesions

Thin-walled unilocular cysts are benign (not classified).
Thick-walled/multilocular cysts, growth in wall thickness or cystic component, or a cyst with an adjacent nodule → manage as atypical cyst (often 4A/4B).

Slow-growing nodules

Ground-glass: May remain Category 2 despite slow enlargement until they reach criteria for another category (e.g., develop a solid component).
Solid/part-solid: Slow growth over multiple screens is suspicious; consider 4B even if 12-month interval growth is ≤1.5 mm. PET can be falsely negative; biopsy/surgical evaluation may be appropriate.
...
False positives: Common; most positive screens resolve with surveillance rather than invasive procedures when standardized pathways (Lung-RADS) are used.
Invasive work-ups: Needle biopsy and surgery entail small but real risks; benign resections should be minimized via MDT triage and PET for the right lesions (solid ≥8 mm).
Incidental findings: Emphysema and CAD calcification are frequent and require contextual counseling and targeted referrals.
...
Immunocompromised: New multiple nodules often infectious—use short-interval follow-up, and classify accordingly (often Category 0 with 1–3 month LDCT).
...
A. Eligibility & Enrollment Flowchart
...
Category 3: 6-month LDCT, then step-down if stable.
Category 4A: 3-month LDCT; PET/CT if solid component ≥8 mm; escalate if growth.
Category 4B/4X: Diagnostic CT ± contrast, PET/CT, tissue diagnosis (bronchoscopy, percutaneous, or upfront surgery) based on pretest probability and patient fitness.
...
| CMS       | 50–77     | ≥20 pack-years                           | &lt;15 years | Coverage policies apply; same clinical stop rules as USPSTF             |
...
Table 2. Lung-RADS v2022 (Condensed Definitions)

Key definitions:

Growth: &gt;1.5 mm (mean) over 12 months.
Slow growth across multiple rounds in solid/part-solid lesions is suspicious even without 12-month threshold change.
See Post-Procedure Care section for full Category logic.
...
Expectations: Annual scans; short-interval follow-ups if something looks indeterminate.
Cessation: The most powerful step you can take—support and medications are available.
...
The primary mortality outcome demonstrated by large LDCT trials in high-risk adults was: Answer: C. Explanation: LDCT reduces lung cancer deaths and shifts detection to earlier stages; some trials also showed all-cause mortality reduction.
A. No change in lung cancer mortality
B. Reduction in lung cancer mortality with no stage shift
C. Reduction in lung cancer mortality with stage shift toward early disease (Correct)
D. Reduction only in all-cause mortality
E. Increased lung cancer incidence without mortality effect
According to USPSTF 2021, which patient qualifies for screening? Answer: B. Explanation: Age 50–80 with ≥20 pack-years and current or quit &lt;15 years ago.
A. 47-year-old, 30 pack-years, quit 5 years ago
B. 55-year-old, 25 pack-years, still smoking (Correct)
...
A 65-year-old with 40 pack-years (quit 18 years ago) asks about screening. He is otherwise fit. Best answer? Answer: A. Explanation: USPSTF/CMS include a 15-year quit limit; some societies (ACS) differ but payer coverage may not.
A. Under USPSTF, he is not eligible due to quit-time &gt;15 years. (Correct)
...
Baseline LDCT shows a new 7 mm solid nodule without worrisome features. Lung-RADS category and next step: Answer: B. Explanation: New solid 6–&lt;8 mm is 4A.
A. 2 → annual LDCT
B. 4A → 3-month LDCT; consider PET if ≥8 mm (Correct)
C. 3 → 6-month LDCT
D. 4B → PET/CT and biopsy
E. 0 → repeat LDCT immediately
Which is true about airway nodules in CTLS? Answer: B. Explanation: Segmental/proximal airway nodules persistent at 3 months are upgraded from 4A to 4B.
A. Subsegmental airway nodules are always 4A.
B. Persistent segmental/proximal airway nodules at 3 months are upgraded to 4B. (Correct)
...
Growth under Lung-RADS v2022 is defined as: Answer: B. Explanation: Growth is defined as &gt;1.5 mm increase in mean diameter over 12 months.
A. Any visual increase
B. &gt;1.5 mm increase (mean diameter) within 12 months (Correct)
C. &gt;2.5 mm increase in longest axis
D. Doubling time &lt;600 days
E. New attenuation change alone
Which nodule is 4B at baseline? Answer: C. Explanation: Solid nodules ≥15 mm are Category 4B.
A. Part-solid 14 mm with 6 mm solid core
B. New solid 7 mm nodule
C. Solid 16 mm nodule (Correct)
D. Non-solid 32 mm nodule stable for 2 years
E. Perifissural 9 mm triangular solid nodule
Appropriate use of PET/CT in CTLS includes: Answer: B. Explanation: PET/CT is indicated for solid nodules or solid components ≥8 mm.
A. Any non-solid nodule ≥20 mm
B. Solid nodule or solid component ≥8 mm (Correct)
C. New solid nodule 4–5 mm
D. Subsegmental airway nodules
E. All category 3 nodules
Typical effective dose of an LDCT screening exam: Answer: C. Explanation: The effective dose for LDCT screening is typically ~1–1.5 mSv.
A. 0.05 mSv
B. 0.3 mSv
C. ~1–1.5 mSv (Correct)
D. 5–6 mSv
E. 10–12 mSv
Overdiagnosis in lung cancer screening refers to: Answer: B. Explanation: Overdiagnosis is the detection of indolent cancers that would not have become clinically apparent.
A. False-positive imaging results
B. Detection of cancers that would not cause symptoms/death during a patient’s lifetime (Correct)
C. Misclassification due to motion artifact
D. Overcalling incidental findings
E. Double-counting nodules
Which is not recommended for lung cancer screening? Answer: C. Explanation: Routine chest radiographs and sputum cytology are not recommended screening modalities.
A. Annual LDCT in eligible high-risk adults
B. Shared decision-making and cessation support
C. Routine chest radiograph ± sputum cytology (Correct)
D. Lung-RADS-based reporting
E. Registry-based QA and adherence tracking
A 70-year-old with fibrotic ILD and 30 pack-years (still smoking) is eligible and fit. LDCT shows a thick-walled cyst with new internal nodularity. Best management? Answer: C. Explanation: Atypical cysts with growing nodularity or complexity are treated as suspicious (4B) requiring diagnostic evaluation.
A. Annual LDCT only
B. 6-month LDCT
C. Treat as 4B: diagnostic chest CT ± contrast; PET/CT if ≥8 mm solid component; tissue diagnosis (Correct)
...
CTLS: Computed Tomography Lung Screening
