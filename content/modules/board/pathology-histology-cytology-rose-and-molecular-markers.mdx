...
Select and sequence appropriate biomarker assays (IHC, FISH, PCR, NGS, liquid biopsy) based on the clinical question and specimen constraints.
...
Neuroendocrine spectrum: Typical/atypical carcinoid (lower‑to‑intermediate grade) versus high‑grade small cell carcinoma (SCLC) and large cell neuroendocrine carcinoma (LCNEC). SCLC shows nuclear molding and very high Ki‑67; LCNEC has neuroendocrine morphology with a high mitotic index.
...
Common exam trap: Reporting PD‑L1 on a crushed, necrotic, or scant sample without pathologist comment on adequacy—this can mislead therapy selection.
...
Smear preparation:
Expel a tiny droplet; make thin smears with gentle “pull‑apart” or “feathering.”
Prepare at least one air‑dried smear for rapid staining and one alcohol‑fixed smear for Pap.
...
flowchart TD
        ...
        B -- "No" --> C["Redirect pass / adjust needle / new target"]
        C --> A
        B -- "Yes" --> D["Prepare cell block & nucleic-acid rinse"]
        D --> E{"Estimated tumor fraction adequate?"}
        E -- "No" --> F["Additional lesional passes for cell block"]
        F --> D
...
Order PD‑L1 only
Order ALK FISH only
Order comprehensive DNA±RNA NGS panel and PD‑L1 on the same cell block
Repeat EBUS for more tissue before any testing
Order pan‑TRK IHC only
...
Switch to immunotherapy monotherapy
Tissue re‑biopsy of progressing site for resistance testing
Start chemotherapy without further testing
Order ALK IHC
Repeat plasma in 6 months
...
Report NTRK fusion and start TRK inhibitor
Treat as wild‑type
Confirm with RNA‑based fusion testing (or FISH) using reserved material or a new sample
Disregard IHC due to low specificity
Repeat pan‑TRK IHC with a different clone
...
Request deeper levels from the same block
Repeat NGS on the same sample
Obtain an alternative site biopsy using non‑acid decalcification or a soft‑tissue target
Substitute PD‑L1 IHC for NGS
Rely on plasma alone for all future testing

Answer: C. Acid decalcification degrades nucleic acids; select an alternative site or EDTA‑based approach.

Question Bank

1. Next best step: ROSE shows scant atypical cells and extensive necrosis from a mediastinal node; the patient is not a candidate for repeat procedures. Which action best preserves treatment options?

Use all remaining material for PD‑L1 only
Prioritize cell block creation and a limited, hotspot PCR panel
Exhaust material on lineage IHC before cell block
Discard bloody rinses
Delay all testing until radiographic progression
...
2. Procedural troubleshooting: Thick, heaped smears with crush artifact repeatedly prevent cytologic interpretation during ROSE. What is the most effective immediate correction?

Increase pressure on the spreader slide
Air‑dry all slides before staining
Use a feathering technique with minimal pressure and prepare more cell‑block material
Switch to acid decalcification
Proceed without ROSE

Answer: C. Gentle feathering reduces crush; capturing more in cell block safeguards downstream studies.

3. In invasive mucinous adenocarcinoma of the lung, which feature is most typical?

Strong, diffuse TTF‑1 positivity in nearly all cases
Frequent KRAS mutations and potential TTF‑1 negativity
Pathognomonic p40 positivity
Exclusive central airway origin
Universal EGFR exon 19 deletions

Answer: B.

4. Which pair of lineage‑defining markers most reliably separates adenocarcinoma from squamous cell carcinoma in small biopsy/cytology?

CK7 and CK20
TTF‑1 (±napsin A) and p40 (±p63)
GATA3 and SOX10
...
5. Which statement about PD‑L1 testing is most accurate?

All clones are analytically identical and interchangeable in every context
Scoring requires cytoplasmic intensity only
Use a validated assay; report membranous tumor‑cell percentage and follow therapy‑linked assay conventions
PD‑L1 cannot be performed on cell blocks
Necrosis and crush artifact do not affect interpretation

Answer: C.

6. An ALK IHC is equivocal on a small cell block with limited material. What is the most appropriate confirmation strategy?

Repeat ALK IHC only
Break‑apart FISH or RNA‑based fusion testing using conserved material
Ignore ALK due to low pretest probability
Order EGFR PCR first
PD‑L1 testing supplants ALK testing

Answer: B.

7. Regarding NGS on FFPE, which pre‑analytic condition most threatens assay success?

Standard 10% neutral buffered formalin fixation
Air‑dried ROSE slide in parallel
Heavy metal fixatives or acid decalcification
Separate passes for cell block
H&E‑stained slide review before macro‑dissection

Answer: C.

8. Next best step after progression on first‑/second‑generation EGFR TKI with radiologic growth: plasma ctDNA is positive for EGFR T790M.

Continue current TKI and reimage later
Switch to appropriate third‑generation EGFR inhibitor
Start dual immune checkpoint blockade
Treat with platinum doublet immediately
Perform ALK FISH

Answer: B.

9. Which association is correct for SCLC?

Low Ki‑67 and rare mitoses
Frequent nuclear molding and high mitotic activity
Common ALK fusion
Strong p40 positivity
Indolent course comparable to typical carcinoid

Answer: B.

10. PD‑L1 IHC is ordered on a scant, crushed cell block with marked necrosis. What is the best interpretive practice?

Report PD‑L1 high without comment
Cancel PD‑L1 and rely on plasma
Report with an adequacy caveat and, if discordant clinically, consider repeat sampling
Convert to FISH
Assume low expression due to poor preservation

Answer: C.

11. Which biomarker–assay pairing is most appropriate when tissue is limited and a specific fusion is suspected?

BRAF—FISH only
NTRK—RNA‑based NGS or confirmatory FISH after pan‑TRK IHC screen
KRAS—ALK IHC
PD‑L1—PCR
EGFR—Break‑apart FISH

Answer: B.

12. When using immune‑modified response frameworks, which statement is most accurate?

iRECIST replaces RECIST 1.1 in all practice
Pseudoprogression is common in NSCLC
iRECIST introduces iUPD with required confirmation before labeling iCPD
New lesions always equal confirmed progression
Best overall response cannot occur after initial progression
...
Travis WD, Brambilla E, Noguchi M, et al. International multidisciplinary classification of lung adenocarcinoma. J Thorac Oncol. 2011;6(2):244‑285.
Yoshizawa A, Motoi N, Riely GJ, et al. Impact of proposed IASLC/ATS/ERS classification of lung adenocarcinoma: prognostic subgroups and implications for further revision of staging based on analysis of 514 stage I cases. Mod Pathol. 2011;24(5):653‑664.
Tsao MS, Marguet S, Le Teuff G, et al. Subtype classification of lung adenocarcinoma predicts benefit from adjuvant chemotherapy. J Clin Oncol. 2015;33(30):3439‑3446.
Rami‑Porta R, Bolejack V, Crowley J, et al. Proposals for revisions of the T descriptors in the 8th edition TNM classification for lung cancer. J Thorac Oncol. 2015;10(7):990‑1003.
Detterbeck FC, Franklin WA, Nicholson AG, et al. Criteria to distinguish separate primary lung cancers from metastatic foci in patients with two lung tumors. J Thorac Oncol. 2016;11(5):651‑665.
...
Lynch TJ, Bell DW, Sordella R, et al. Activating mutations in EGFR underlying responsiveness to gefitinib. N Engl J Med. 2004;350(21):2129‑2139.
...
Lin JJ, Shaw AT. Recent advances in targeting ROS1 in lung cancer. J Thorac Oncol. 2017;12(11):1611‑1625.
Planchard D, Smit EF, Groen HJM, et al. Dabrafenib plus trametinib in untreated BRAF V600E–mutant metastatic NSCLC: phase 2 trial. Lancet Oncol. 2017;18(10):1307‑1316.
Liu X, Jia Y, Stoopler MB, et al. High frequency of actionable MET gene mutations in pulmonary sarcomatoid carcinoma. J Clin Oncol. 2016;34(8):794‑802.
Drilon A, Hu ZI, Lai GGY, Tan DSW. Targeting RET‑driven cancers: evolving landscapes. Nat Rev Clin Oncol. 2018;15(3):151‑167.
...
Jordan EJ, Kim HR, Arcila ME, et al. Prospective molecular characterization of lung adenocarcinomas. Cancer Discov. 2017;7(6):596‑609.
...
Rittmeyer A, Barlesi F, Waterkamp D, et al. Atezolizumab versus docetaxel in previously treated NSCLC (OAK). Lancet. 2017;389(10066):255‑265.
Fehrenbacher L, Spira A, Ballinger M, et al. Atezolizumab vs docetaxel (POPLAR). Lancet. 2016;387(10030):1837‑1846.
Garon EB, Rizvi NA, Hui R, et al. Pembrolizumab for NSCLC (KEYNOTE‑001). N Engl J Med. 2015;372(21):2018‑2028.
Borghaei H, Paz‑Ares L, Horn L, et al. Nivolumab vs docetaxel in nonsquamous NSCLC (CheckMate 057). N Engl J Med. 2015;373(17):1627‑1639.
