...
Execute a stepwise algorithm for intra‑procedural bleeding control and identify when to escalate to rigid bronchoscopy or embolization.
...
Pneumothorax risk: ~0.1–0.8% overall; increases to ~11% after forceps transbronchial lung biopsy (TBLB) and ~5% with interstitial lung disease (ILD) cryobiopsy.
Post‑bronchoscopy fever (PBF): Occurs in ~5–16% after BAL; usually a sterile cytokine response.

Pearls & Pitfalls

Bleeding classification: Classify by the intervention required, not the estimated volume.
...
Sedation (conscious/moderate): Midazolam 1–2 mg IV then 0.5–1 mg; fentanyl 25–50 µg IV titrated. Reversal: Flumazenil 0.2 mg then 0.1 mg/min to 1 mg; naloxone start 0.04 mg, repeat q2–5 min (up to ~0.01 mg/kg).
Pregnancy: Anticipate difficult airway; avoid the nasal route; wedge the right hip (left uterine displacement); minimize hypercarbia; use lowest effective lidocaine dose; multidisciplinary planning.
...
Tools: Large‑channel bronchoscope; robust suction; cold saline; topical vasoconstrictors (epinephrine, tranexamic acid); vasopressin analogs where appropriate; balloon blockers; fibrin sealant or silicone plugs; thermal tools (APC, laser, monopolar electrocautery) for select bleeding scenarios.
...
Sedation: Midazolam + fentanyl titration; avoid large boluses. If using propofol, anesthesia support is recommended. Ensure reversal agents are drawn up.
Oxygenation: Start supplemental O₂ in high‑risk patients; HFNC for those prone to desaturation.
Pregnancy Specifics: Avoid nasal route; wedge right hip; minimize hypercarbia; plan for aspiration risk and difficult airway.
PH Specifics: Continue PAH meds; avoid maneuvers that increase PVR; maintain preload; ensure gentle instrumentation.
...
Sedation mishaps: Keep flumazenil and naloxone immediately available; recognize fentanyl‑induced chest‑wall rigidity ("wooden chest") and support ventilation while reversing.

Post‑Procedure Care & Follow‑Up

Recovery: Monitor in a staffed recovery area for 2–4 hours: SpO₂ (return to baseline), chest pain/desaturation (consider pneumothorax), temperature (self‑limited fever common after BAL), airway patency/bronchospasm, and level of consciousness. Keep NPO until cough reflex returns (~2 h).
Imaging: Symptomatic pneumothorax warrants imaging (CXR or lung ultrasound). Small (&lt;20%) pneumothoraces can often be observed; larger or unstable cases require drainage.

Complications: Prevention, Recognition, Management

Bleeding

Highest risk with vascular tumors and TBLB/cryobiopsy. Prophylactic epinephrine prior to TBLB in select transplant populations reduces severe bleeding. Consider rigid bronchoscopy first in centrally vascular endobronchial tumors; thermal modalities can assist hemostasis.

Pneumothorax

Avoid bilateral same‑session TBLB; prefer alligator over cup forceps in sarcoidosis; fluoroscopy improves localization yield but doesn’t clearly reduce pneumothorax risk. Routine immediate CXR isn’t required; observe ≥2 h due to possible delayed onset.

Infection/PBF

PBF is common after BAL and typically sterile. Prophylactic antibiotics do not reduce PBF. Procalcitonin can help distinguish bacterial infection from PBF. True bacteremia occurs in a minority; typical organisms include staphylococci and streptococci.

Bronchospasm

The most common life‑threatening airway event in older surveys. Routine pre‑procedure bronchodilators (short‑acting β‑agonists) have not shown clear benefit in COPD/asthma; optimize baseline disease control instead.
...
Use of topical endobronchial epinephrine is a theoretical concern for uterine blood‑flow reduction—try safer measures first and weigh risk–benefit if considering its use.
...
Multidisciplinary coordination (IP, anesthesia, obstetrics, referring team) is essential.

Pulmonary Hypertension

No consistent increase in TBLB bleeding risk; however, there is a higher risk of peri‑procedural hypoxemia and prolonged mechanical ventilation.
...
graph TD
    ...
    C -- Yes --> C1["Continue PAH meds; avoid increased PVR; gentle technique; maintain preload"]
    C -- No --> D["Standard pathway"]
    B1 --> E{"Antithrombotics?"}
    C1 --> E
    D --> E
    E -- Yes --> F["Hold per local protocol; INR < 1.5 if on warfarin; tailor for renal function with DOACs"]
    E -- No --> G["Conscious sedation with midazolam + fentanyl; reversal agents ready; consider HFNC"]
    F --> G
...
| Respiratory pattern | Tachypnea/wheeze/accessory muscle use | Bronchospasm            | Bronchodilators, systemic steroids, oxygen; escalate as needed.  |
...
Scenario: A 62‑year‑old with scleroderma‑ILD and mean PAP 40 mmHg is referred for BAL/TBLB for new ground‑glass opacities. Which statement best reflects risk?
...
Scenario: A 29‑year‑old at 22 weeks with suspected mediastinal involvement from breast cancer is scheduled for EBUS. What are the key priorities?
...
Scenario: Two hours post‑TBLB, a patient reports pleuritic chest pain and desaturates to 89%.
...
Ali J, et al. Bronchoscopy in pulmonary hypertension: meta‑analysis. Ann Am Thorac Soc. 20(6):898‑905.
Bahhady I, Ernst A. Bronchoscopy in pregnancy. Chest. 2004;126.
Morgan R, Ernst A. Bronchoscopy during pregnancy. Clin Chest Med. 2011;32.
Tang SJ, et al. ERCP in pregnancy: safety of sphincterotomy. Gastrointest Endosc. 2009;69.
