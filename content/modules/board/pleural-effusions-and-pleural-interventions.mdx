...
Select and place small-bore vs. large-bore chest drains; choose water seal vs. suction; and troubleshoot air leaks, blockage, malposition, and re-expansion pulmonary edema (RPE) risk.
Construct management pathways for pleural infection (Antibiotics + tube vs. fibrinolytics + DNase vs. surgery) and MPE (serial taps vs. IPC vs. talc pleurodesis vs. thoracoscopy).
...
Anticipate, prevent, and manage complications (pneumothorax, hemothorax, infection, RPE, subcutaneous emphysema) and identify indications for post-procedure imaging.

High-Yield One-Pager (Pearls, Pitfalls, and Common Exam Traps)

Ultrasound is the standard of care for thoracentesis and tube placement; it significantly reduces pneumothorax rates and “dry taps.”
Light’s criteria remain first-line to classify exudates; however, borderline values reduce accuracy—always use clinical context and ancillary tests.
Large-volume thoracentesis is safe when guided by symptoms and pleural pressures. Stop if Ppl falls below approximately -20 cm H₂O or if the patient develops chest pain or relentless cough.
Do not routinely obtain a post-tap CXR. Reserve imaging for clinical concerns (air aspiration, difficult procedure, prior radiation, symptoms, etc.).
Small-bore (≤14F) chest tubes suffice for most effusions and pneumothoraces; they are better tolerated and placed via the Seldinger technique.
When to favor large-bore: Unstable hemothorax/trauma, massive air leak, or immediate post-thoracic surgery (due to flow and clogging considerations).
Suction is not routine for pneumothorax management; water seal often suffices and may reduce fistula propagation.
Pleural infection: Start antibiotics + small-bore tube early. Escalate to intrapleural tPA/DNase if drainage stalls; refer for surgery if the patient is a non-responder.
MPE: Symptomatic recurrent effusions → IPC or talc pleurodesis. Non-expandable lung → IPC. Note that talc slurry via small-bore tube has similar pleurodesis success rates to talc poudrage via thoracoscopy.
Ambulatory devices can be considered for carefully selected primary spontaneous pneumothorax; there is less evidence supporting ambulatory care in secondary SP.
...
Intercostal artery anatomy: The artery's course varies posteriorly. Avoid posterior insertion within 6cm of the spine and always enter just above the rib to protect the neurovascular bundle.
Drain removal:
Pneumothorax: When the lung is expanded and there is no air leak.
Effusions: When output falls (&lt;100–200 mL/day) and the lung re-expands.
Post-procedure ultrasound to confirm residual fluid and tube position is often more actionable than routine radiography.
Trapped vs. Lung Entrapment: A negative baseline with an immediate, steep pressure drop indicates trapped lung (monophasic ex vacuo physiology). In contrast, lung entrapment presents with a positive baseline and a biphasic curve—initially gradual (indicating partial lung expansion) before hitting a sharp inflection point where restriction occurs.

Core Concepts

Pathophysiology / Epidemiology

Pleural effusion reflects an imbalance in formation vs. clearance and has &gt;50 etiologies; approximately 1.5 million people are affected annually in the US.
...
Contraindications (relative): Uncorrected coagulopathy/severe thrombocytopenia (mitigate with technique and targeted correction), overlying cellulitis, inability to cooperate. Mechanical ventilation is not a contraindication when ultrasound-guided.
...
Hemothorax: Unstable → large-bore; stable, non-emergent settings may use 14F with comparable evacuation and less pain.
...
Indications: Undiagnosed exudate suspected to be malignant/TB; therapeutic talc poudrage pleurodesis; adhesiolysis/loculation management in selected cases.
...
Imaging: Bedside TUS defines effusion size, complexity, and loculations; identifies diaphragm and spleen/liver; and helps predict non-expandable lung.
...
Pleural Fluid Orders: Cell count & differential, protein/LDH (Light’s criteria), glucose, pH (for parapneumonic risk), cytology when malignancy is suspected; ADA, amylase, cholesterol, BNP, or rheumatoid factor selectively.
...
Small-bore Drain Kit (≤14F): Introducer needle, guidewire, scalpel, serial dilators, pigtail catheter (often curved tip), securing suture, connection to a 3-chamber collection system.
...
Position: Sit patient upright if tolerated; alternative: lateral decubitus (affected side up).
Prep: Consent, timeout, vital sign baseline, oxygen as needed.
...
Anesthesia: Sterile prep/drape; create a subcutaneous wheal (25-g), then infiltrate along the planned tract with 22-g needle down to pleura.
Entry: Single pass with catheter-over-needle just superior to the rib; aspirate fluid, advance catheter, remove needle.
Drainage: Drain with syringe/one-way valve tubing; consider manometry if targeting large volumes or if symptoms arise.
Termination: Stop for chest pain, relentless cough, vasovagal response, or Ppl &lt; -20 cm H₂O. Cap and remove during expiration; apply occlusive dressing.
Post-procedure: No routine CXR; obtain if air aspiration, multiple attempts, symptoms, or prior chest irradiation/surgery.

Small-bore Chest Tube (Seldinger Technique)

Prep: Review imaging & labs; place patient for optimal lateral access; continuous monitoring; ultrasound-mark site.
Anesthesia: Sterile prep/drape; anesthetize subcutaneous tissues and parietal pleura generously (avoid injecting contaminated fluid back into the tract).
Access: Introduce needle while aspirating; pass guidewire &gt;10 cm into pleura; remove needle.
Placement: Skin nick; serial dilation; advance catheter (pigtail) over wire; remove wire; secure with suture; connect to water seal (± suction).
Check: Confirm drainage/air flow and patient stability; obtain CXR selectively; consider bedside ultrasound for tube position.

Troubleshooting & Intra-procedure Management

No fluid returns on thoracentesis: Ensure needle is coaxial with finder path, check for kink; re-scan; consider lateral/anterior pocket.
...
RPE signals: New hypoxemia + cough/chest pain/infiltrates after large drainage → stop/clamp, provide oxygen and supportive care.
...
Removal:
Pneumothorax: No air leak and re-expansion.
Effusions: Output &lt;100-200mL/day with expansion.
Technique: Valsalva or end-expiratory removal; petroleum gauze closure.

Complications (Prevention, Recognition, Management)

Pneumothorax: Most frequent after thoracentesis; minimized by real-time ultrasound and a single controlled pass.
Bleeding: Protect intercostal bundle by entering just above the rib; posterior “danger zone” near spine increases risk of unpredictable vessel course. Manage with pressure/cautery; major hemorrhage is rare.
Infection: Sterile technique is paramount; drain-site infections and empyema are uncommon.
...
Hemothorax: Stable, non-massive collections may be managed with 14F drains; unstable/massive needs immediate large-bore drainage and surgical consultation.
...
```mermaid
flowchart TD
        A["New pleural effusion"] --> B{"Clear transudative cause
(e.g., CHF) with response to therapy?"}
        B -- Yes --> B1["Consider no tap; treat cause
Tap if atypical/poor response"]
        B -- "No or atypical" --> C["Bedside ultrasound
(size, complexity, loculations)"]
        ...
        F -- "Parapneumonic/empyema" --> G["Start antibiotics + small-bore tube if complicated;
consider tPA/DNase if poor drainage"]
        F -- "Malignancy suspected" --> H["Send cytology; symptom-guided pathway:
IPC vs talc pleurodesis vs repeat taps"]
...
If drainage stalls, consider tPA/DNase.
Persistently septic/non-draining → surgical referral.
MPE: Use cytology; choose IPC vs. talc pleurodesis based on symptoms, expandability, and patient goals.
Trapped lung → IPC.
...
Air:
Primary SP → aspiration or small-bore tube; ambulatory device in selected, reliable patients.
Secondary SP/Trauma → small-bore for most; large-bore if massive leak/vent/instability.
Fluid:
Infection → small-bore tube; escalate with tPA/DNase if needed.
MPE → small-bore for inpatient drainage/talc slurry; IPC for outpatient palliation or non-expandable lung.
Hemothorax → large-bore if unstable/massive; acceptable in stable non-emergent settings.
Suction: Not routine in pneumothorax; use minimally and reassess; caution with effusions to reduce RPE risk.
Removal: With expansion and appropriate thresholds (no air leak; or output &lt;100-200 mL/24h).
...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Transudate | Meets none of Light’s criteria; often bilateral                                                                                                 | CHF, cirrhosis (hydrothorax), nephrotic syndrome, peritoneal dialysis, hypoalbuminemia, atelectasis, constrictive pericarditis, urinothorax                                           |
...
| ------------------------ | ------------------- | -------------------------------------------------------------------------------------- |
| Pleural infection        | Small-bore (≤14F)   | Similar outcomes; less pain; early antibiotics + drainage key; tPA/DNase if needed     |
| MPE – inpatient          | Small-bore          | Efficient drainage; equivalent pleurodesis success to larger tubes                     |
| MPE – outpatient         | IPC                 | Reduces hospital days; effective dyspnea control; compatible with non-expandable lung  |
| Primary SP (symptomatic) | Small-bore          | Appropriate for most; aspiration alternative; ambulatory devices for select primary SP |
| Secondary SP/Traumatic   | Consider large-bore | Flow & clogging concerns; tailor to leak magnitude (e.g., massive leak, ventilated)    |
| Hemothorax – unstable    | Large-bore          | Rapid evacuation; lower clogging risk                                                  |
| Hemothorax – stable      | 14F acceptable      | Comparable evacuation success with less pain in selected settings                      |
...
| Suction control          | Applies negative pressure | Use selectively; -20 cm H₂O typical; digital systems quantify leak & regulate suction                              |
| Positive-pressure relief | Safety feature            | Prevents excessive negative pressure; avoids tension with disconnection                                            |
...
Case 1 A 68-year-old with CHF responds partially to diuresis but remains dyspneic with a large right effusion. Bedside TUS confirms a simple, free-flowing effusion. What’s the best next step?

Best answer: Ultrasound-guided thoracentesis with diagnostic studies and symptom-guided large-volume drainage.
Why: Even in likely transudates, atypical features or incomplete response justify diagnostic/therapeutic tapping; ultrasound reduces complications and improves success.

Case 2 A 55-year-old with community-acquired pneumonia has a septated effusion, pH 7.05, and persistent fevers after antibiotics.

Best answer: Small-bore chest tube drainage plus consideration of intrapleural tPA/DNase.
Why: A complicated parapneumonic effusion needs prompt drainage; fibrinolytics improve clearance and reduce surgery rates in non-responders.

Case 3 A 72-year-old with metastatic breast cancer has recurrent dyspnea weekly from a unilateral effusion; ultrasound reveals poor lung expansion after prior tap.

Best answer: Indwelling pleural catheter (IPC).
...
A 67-year-old with a new unilateral effusion and no clear systemic cause. Best initial diagnostic step?
...
During therapeutic thoracentesis, the patient develops pleuritic chest pain and persistent cough after 1.3 L removed; manometry shows -35 cm H₂O. Next best step?
...
Which post-thoracentesis patient needs a chest radiograph?
...
E. All patients
Answer: B. Imaging is reserved for concerns such as air aspiration, difficult tap, symptoms, or specific risk factors.
Procedural troubleshooting: You cannot aspirate fluid despite ultrasound-confirmed effusion at 4 cm depth. Best next action?
...
A 60-year-old with complicated parapneumonic effusion has persistent sepsis and multiloculations after 48 h of small-bore drainage. Best escalation?
A. Replace with 28F tube
...
In MPE with expandable lung, which option best minimizes inpatient days while maintaining symptom control?
...
Answer: B. IPCs reduce hospital days; pleurodesis is reasonable when inpatient with expandable lung, but IPC is often superior for outpatient burden.
Chest drain management for secondary SP on the ward with steady air leak and no distress. Which is preferred?
A. Water seal without routine suction, monitor air leak
B. Immediate -20 cm H₂O suction
C. Clamp the tube
D. Remove the tube
E. Switch to a Heimlich valve for discharge
Answer: A. Suction is not routinely recommended; water seal is often adequate.
Stable hemothorax after blunt trauma in a monitored setting. Best initial drain choice?
A. 14F small-bore catheter
B. &gt;28F chest tube mandatory
C. IPC
D. Thoracentesis
E. Observe only
Answer: A. In stable, non-emergent hemothorax, 14F shows comparable evacuation with less pain; unstable/massive needs large-bore.
Which finding most strongly suggests trapped lung during thoracentesis?
A. Late precipitous pressure drop after initial normal pressure
B. Negative baseline pleural pressure with steep pressure change during thoracentesis
C. Pleural pressure remains slightly positive after 2 L removed
D. High ADA level
E. Cloudy fluid with high LDH
Answer: B. A negative baseline with an immediate, steep pressure drop indicates trapped lung.
Best next step for a patient with recurrent MPE, poor performance status, and non-expandable lung after a complete tap?
...
After small-bore tube placement for empyema, drainage suddenly stops; the patient develops subcutaneous emphysema. First action?
A. Clamp the tube
...
Which statement about pleurodesis in MPE is most accurate?
...
Remove tubes when air leak stops (pneumothorax) or output &lt;100-200 mL/day with lung expansion (effusions).
