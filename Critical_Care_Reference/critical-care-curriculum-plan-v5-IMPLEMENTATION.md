...
Hemodynamics established a shape. Every module has the same shape with different physiology. **Do not invent a new structure per module** — find each module's answer to these six questions, then build the same files.

### 10.1 The six structural roles
