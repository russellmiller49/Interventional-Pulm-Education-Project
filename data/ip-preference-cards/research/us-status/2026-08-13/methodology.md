...
The package evaluates 779 products selected from the deterministic hidden-product manifest. Hidden verified-source products are current-U.S.-status pending; hidden candidate and unknown products remain identity/specification pending.
...
- active exact product action: 47
- historical exact product action: 2
- family or ambiguous action: 10
- no exact action found: 678
- unknown: 42
- products with an exact-product safety record: 49
