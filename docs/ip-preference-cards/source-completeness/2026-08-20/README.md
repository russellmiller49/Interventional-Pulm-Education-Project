...
| --------------------------------------------------------------------------- | ----: |
| Scanner candidates (unique identifier per document)                         |  5783 |
| Dispositions assigned                                                       |  5783 |
| Unhandled candidates                                                        |     0 |
| Represented in the original CSV                                             |   533 |
| Exact identifiers of pre-review canonical products                          |  1006 |
| Alias/format variants of canonical products                                 |    96 |
| Accepted new exact product rows                                             |   326 |
...
| Measure                                             | Count |
| --------------------------------------------------- | ----: |
| Old-corpus exact products added by this review      |   185 |
| Owner-supplied PDF candidates                       |    40 |
| Official-web-only candidates                        |    22 |
| New exact products added (all origins)              |   229 |
...
- All 229 new products are `verified_source`, `visibility_state=hidden`, and make no local-orderability claim.
- 223 products receive an existing, evidence-supported role; six remain intentionally roleless.
...
- `old-corpus-candidate-extraction.csv`: the complete 5783-candidate scanner output with detection metadata.
...
- `source-product-discovery.csv`: complete 249-row product-level controlled-disposition ledger.
...
- `new-product-additions.csv`: the 229 accepted exact products.
