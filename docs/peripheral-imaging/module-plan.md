...
> **Superseded for the first pilot (2026-09-14, PI-02).** The [PI-02 session plan](../gap-remediation/pi/PI-02-usability-session-plan.md) keeps the 3–5 learners with a technologist and the start, resume, change-controls and locate moments, but as observations of the module, not tasks to pass. It drops time estimates, first-attempt errors and drop-off analytics. The paragraph above is kept as the historical proposal.
