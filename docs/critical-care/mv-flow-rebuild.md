...
| 5    | Explain   | The verdict in full, the before-and-after table, the explanation; in the Teaching panel (the middle pane — this row used to say "on the right", which it never was) the analogy, precise statement, checklist, the one table, the control strip, the live teaching panel and the boundary. Section 3 adds a settings sort here. Amended by [`mv-learner-review-record.md`](./mv-learner-review-record.md). |
