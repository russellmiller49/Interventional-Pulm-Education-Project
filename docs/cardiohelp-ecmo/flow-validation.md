...
**Dated note, ECMO-03 (2026-09-15).** This protocol is adapted for the self-paced module in [ECMO-03-observation-guide.md](../gap-remediation/self-paced/ECMO-03-observation-guide.md). There, help, explanations, references, replay and skipping are normal use, and the instruction above not to supply an answer while observing does not apply. The gas-to-air transfer block described above was fixed in ECMO-01. No session has been run under either document, and the results above remain automated evidence.
