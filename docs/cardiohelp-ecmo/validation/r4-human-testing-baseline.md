...
- **The navigation-competence precondition is now a task.** `b5-novice-participant-tasks.md` opens
  with Task 0: from the module's front page the participant must reach the intended starting point
