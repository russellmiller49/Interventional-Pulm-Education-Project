...
- Committed answer, verdict, and a separate Continue survive context switching.
- Help targeting reveals the simulator pane before focusing the control, in compact.
