...
| ICU-21 | Action-only or unresolved-device runs earn mastery                | Modeled-response gate, never-started history predicates, unresolved-limitation predicates, and safe/adversarial trajectory tests |
