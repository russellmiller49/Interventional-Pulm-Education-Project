...
> **Self-paced since BBT-01 (September 14, 2026).** The owner's self-paced decision supersedes the examination wording kept below as history: the orientation check, independent parent-view responses, Assess withholding comparisons until submission, first-attempt and hint records. Current behavior, storage and test contracts are in [the BBT-01 handoff](../gap-remediation/self-paced/BBT-01-handoff.md). **BBT-02 (same day)** adds junction feedback to the local lessons: a millimetre position comparison of the learner's own marks against the model locators, and for five pilot junctions an authored explanation of divergence, deciding wall, slices to revisit and uncertainty, plus names with an optional unrecorded try; see [the BBT-02 handoff](../gap-remediation/self-paced/BBT-02-handoff.md) and the NOT REVIEWED [five-junction packet](../gap-remediation/bbt/BBT-02-junction-packet.md). `/assess` now opens four more routes with the same references and help as Practice. Source geometry, coordinates, assets and draft identities are unchanged.
