...
export type ScopeViewProfileId = "flexible" | "robotic";

export interface ScopeCalibrationProfilePayload {
  label?: string;
  description?: string;
...
export interface ScopeCalibrationPayload {
  ...
  exportedAt?: string;
  updatedAt?: string;
  defaultProfile?: ScopeViewProfileId | string;
  profiles?: Record<string, ScopeCalibrationProfilePayload>;
  adjustments: Record<string, Partial<ScopeAdjustment>>;
}
